 ...
 /*chart-bar-stacked*/
	var chart = c3.generate({
		...
		data: {
			columns: [
				// each columns data
				['data1', 11, 8, 15, 18, 19, 17, 20, 25, 32, 20, 14,20,10,0,0,0,0,0,0,0,0,0,10,10,20,30,30,10,20,30,10],
				['data2', 7, 7, 5, 7, 9, 12, 4, 6, 2, 5, 2, 8,10,0,20,30,40,50,40,50,40,20,10,10,20,30,30,10,20,30,10],
				['data3', 7, 7, 5, 7, 9, 12, 4, 6, 2, 5, 2, 8,10,0,20,30,40,50,40,50,40,20,10,10,20,30,30,10,20,30,10],				
				['data4', 7, 7, 5, 7, 9, 12, 4, 6, 2, 5, 2, 8,10,0,20,30,40,50,40,50,40,20,10,10,20,30,30,10,20,30,10],
				['data5', 7, 7, 5, 7, 9, 12, 4, 6, 2, 5, 2, 8,10,0,20,30,40,50,40,50,40,20,10,10,20,30,30,10,20,30,10],
	...
	/*chart-pie*/
	var chart = c3.generate({
		bindto: '#chart-pie15', // id of chart wrapper
		data: {
			columns: [
				// each columns data
				['data1', 63],
	...
	/*chart-pie*/
	var chart = c3.generate({
		bindto: '#chart-pie16', // id of chart wrapper
		data: {
			columns: [
				// each columns data
				['data1', 63],
	...
	/*chart-pie*/
	var chart = c3.generate({
		bindto: '#chart-pie14', // id of chart wrapper
		data: {
			columns: [
				// each columns data
				['data1', 63],
